...
<section class="section band band--sand" aria-labelledby="about-title">
	<div class="container about" id="about" data-reveal>
		<div class="about__first">
			<?php savta_the_section_number( '01', 'section-num--deep' ); ?>
			<h2 class="h2 about__title" id="about-title"><?php esc_html_e( 'מה זה', 'savta' ); ?><br><?php esc_html_e( '"סבתא על הספסל"?', 'savta' ); ?></h2>
			<?php savta_the_window( 'about', 'arch-down', array( 'sizes' => '(min-width: 760px) 420px, 100vw' ) ); ?>
		</div>
		<div class="about__second">
			<p class="body-18"><?php esc_html_e( '"סבתא על הספסל" הוא מיזם חברתי שנולד מתוך צורך אמיתי בקהילה: לאפשר לאנשים לעצור לרגע, לשבת לשיחה אישית, לפרוק מה שיושב על הלב, ולקבל הקשבה טובה, מכבדת ולא שיפוטית.', 'savta' ); ?></p>
			<blockquote class="pull">
				<p><?php esc_html_e( 'זו לא קליניקה. זה לא טיפול. וזו לא שיחה שמבטיחה לפתור הכול.', 'savta' ); ?></p>
			</blockquote>
			<p class="body-18 about__last"><?php esc_html_e( 'זו שיחה אנושית, חמה ודיסקרטית — עם "סבתא" מקשיבה, מנוסה ורגישה, שעברה הכוונה מתאימה ומגיעה עם ניסיון חיים, לב פתוח ויכולת לראות את האדם שמולה.', 'savta' ); ?></p>
