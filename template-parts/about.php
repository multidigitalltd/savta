...
<section class="section band band--sand" aria-labelledby="about-title">
	<div class="container about" id="about">
		<div class="about__first">
			...
			<h2 class="h2 about__title" id="about-title" <?php echo savta_reveal(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php savta_e_br( 'about_title' ); ?></h2>
			<?php savta_the_window( 'about', 'arch-down', array( 'sizes' => '(min-width: 760px) 420px, 100vw' ) ); ?>
		</div>
		<div class="about__second">
			<p class="body-18" <?php echo savta_reveal( 'up', 0.1 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php savta_e( 'about_p1' ); ?></p>
			<blockquote class="pull" <?php echo savta_reveal( 'right', 0.2 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				<p><?php savta_e( 'about_pull' ); ?></p>
			</blockquote>
			<p class="body-18 about__last" <?php echo savta_reveal( 'up', 0.3 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php savta_e( 'about_p2' ); ?></p>
			<div class="about__goal" <?php echo savta_reveal( 'up', 0.4 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				...
				<p class="about__goal-text"><?php savta_e( 'about_goal' ); ?></p>
			</div>
		</div>
	</div>
</section>
