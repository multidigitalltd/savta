...
<section class="section intro" aria-label="<?php esc_attr_e( 'פתיח', 'savta' ); ?>">
	<div class="container intro__grid" data-reveal>
		...
		<div class="intro__text">
			...
			<p class="intro__big"><?php esc_html_e( 'יש רגעים שבהם הכול נראה "בסדר" מבחוץ, אבל בפנים יש עומס, מחשבות, דאגה או תחושה שאין באמת עם מי לדבר.', 'savta' ); ?></p>
			<p class="intro__body"><?php esc_html_e( 'לא תמיד צריך פתרונות גדולים. לפעמים צריך מקום שקט, לב פתוח, ואוזן קשבת של מישהי שכבר ראתה הרבה בחיים — ויודעת להקשיב בלי לשפוט.', 'savta' ); ?></p>
		</div>
	</div>
</section>
