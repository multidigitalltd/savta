...
<section class="section intro" aria-label="<?php esc_attr_e( 'פתיח', 'savta' ); ?>">
	<div class="container intro__grid">
		...
		<div class="intro__text">
			...
			<p class="intro__big" <?php echo savta_reveal( 'up', 0.1 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php savta_e( 'intro_big' ); ?></p>
			<p class="intro__body" <?php echo savta_reveal( 'up', 0.25 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php savta_e( 'intro_body' ); ?></p>
		</div>
	</div>
</section>
